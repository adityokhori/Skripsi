...
# Gunakan PostgreSQL untuk production, SQLite untuk development
DATABASE_URL = os.getenv("DATABASE_URL", "sqlite:///./sentiment_analysis.db")

# Fix untuk Render.com/Heroku (mengubah postgres:// menjadi postgresql://)
...
if "sqlite" in DATABASE_URL:
    ...
    # PostgreSQL tidak butuh check_same_thread
    engine = create_engine(
        DATABASE_URL,
